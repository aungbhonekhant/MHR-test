...
<div class="card card-secondary">
    ...
    <!-- /.card-header -->
    {{-- message --}}
    @if (Session::has('client_edited'))
        <div class="callout callout-success mt-2 mx-2">
            <p>{{ Session::get('client_edited') }}</p>
        </div>
    @endif
    ...
    <form method="POST" action="{{ route('clients.update',$client->id) }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value={{ $client->email }} class="form-control" id="exampleInputEmail1" placeholder="Enter email">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Address</label>
                <textarea class="form-control" name="address" rows="3" placeholder="Enter ...">{{ $client->address }}</textarea>
            </div>
            <div class="form-group">
                ...
                <img src="{{ asset('storage')}}/{{ $client->photo }}" alt="" style="max-width: 130px; margin-top: 20px">
            </div>
        </div>
        <!-- /.card-body -->
